...
class Index extends Component {
  ...
  render() {
    return (
      <View className="trade-detail-page">
        <view className="title">二手交易</view>
        <view className="content">
          <View className="trade-detail-page-card">
            ...
            <view className="title">
              ...
              <view className="price">
                ...
                <view className="origin-price">{this.state.originPrice}</view>
                <view className="current-price">{this.state.currentPrice}</view>
              </view>
            </view>
            <view className="content">
